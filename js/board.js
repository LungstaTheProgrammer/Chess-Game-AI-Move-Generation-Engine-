...
function SqAttacked(sq, side) {
    ...
    if (side == COLOURS.WHITE) {
        // if white is top-bottom sq - 11 and sq - 9
        // if white is bottom-top sq + 11 and sq + 9
        // can just keep board this way in the back and 
        // flip it on one player's side in the front
